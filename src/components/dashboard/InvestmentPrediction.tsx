          ...
          <div className="flex items-center justify-between">
            <div className="text-white">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h1 className="text-3xl font-bold">EcoVest Dashboard</h1>
                  <p className="text-emerald-100 text-sm">AI-Powered Sustainable Investment Platform</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-emerald-100">Markets Open</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-emerald-200">ESG Index:</span>
                  <span className="text-white font-semibold">+2.4%</span>
                  <span className="text-emerald-200">Green Bonds:</span>
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-3 w-64 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-white/70 focus:ring-2 focus:ring-white/30 focus:border-white/30 focus:bg-white/20 transition-all"
                />
              </div>
              
              <button className="p-3 text-white/80 hover:text-white hover:bg-white/10 rounded-xl transition-all relative">
              ...
              <div className="hidden lg:flex items-center gap-4 ml-4 pl-4 border-l border-white/20">
                <div className="text-center">
                  ...
                  <div className="text-xs text-emerald-200">Opportunities</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-white">
                    {Math.round(filteredInvestments.reduce((acc, inv) => acc + inv.esgScore, 0) / filteredInvestments.length || 0)}
                  </div>
                  <div className="text-xs text-emerald-200">Avg ESG</div>
                </div>
              </div>
            </div>
          </div>
